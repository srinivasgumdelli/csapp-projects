public class Goban
{
    ...
    private void setBorder(Affiliation c)
    {
	for(int i = 0; i < _board.length; i++)
	    {
	...
	if(this.checkBounds(x, y))
		...
		Affiliation ownColor = _board[x][y].getAffiliation();
		if(ownColor == Affiliation.WHITE)
		    this.setBorder(Affiliation.BLACK);
		else if(ownColor == Affiliation.BLACK)
		    this.setBorder(Affiliation.WHITE);
	...
	this.setBorder(Affiliation.NONE);
	return ret;
    }
    ...
    private void markTerritory(Affiliation c, int x, int y)
    {
	...
	if(valid)
	    {
		if(c == Affiliation.DISPUTED)
		    {
			_board[x][y].setAffiliation(Affiliation.DISPUTED);
			this.markTerritory(Affiliation.DISPUTED, x, y + 1);
			this.markTerritory(Affiliation.DISPUTED, x + 1, y);
			this.markTerritory(Affiliation.DISPUTED, x, y - 1);
			this.markTerritory(Affiliation.DISPUTED, x - 1, y);
		    }
		else if( _board[x][y].getAffiliation() == Affiliation.NONE)
		    {
		    ...
		    this.markTerritory(Affiliation.DISPUTED, x, y);
	    }
    }

    public boolean playStone(Affiliation c, int x, int y)
    {
	boolean ret;
	boolean suicide;
	...
	if(l.getOccupied())
		...
		l.setOccupied(false);
		l.setChecked(false);		
		l.setAffiliation(Affiliation.NONE);
		ret = true;
	    }
	else
	    {
	...
	ban.playStone(Affiliation.WHITE, 0, 8);
	ban.playStone(Affiliation.WHITE, 1, 1);
	ban.playStone(Affiliation.WHITE, 19, 19);
	ban.playStone(Affiliation.BLACK, 2, 8);
	ban.playStone(Affiliation.BLACK, 19, 19);
	ban.playStone(Affiliation.BLACK, 1, 1);
	System.out.println(ban.toString());
	...
	ban = new Goban();
	ban.playStone(Affiliation.WHITE, 10, 10);
	ban.playStone(Affiliation.BLACK, 10, 11);
	ban.playStone(Affiliation.BLACK, 11, 10);
	ban.playStone(Affiliation.BLACK, 10, 9);
	ban.playStone(Affiliation.BLACK, 9, 10);
	System.out.println(ban.toString());
	ban.capture(9, 10);	
	System.out.println(ban.toString());
	...
	ban = new Goban();
	ban.playStone(Affiliation.WHITE, 10, 10);
	ban.playStone(Affiliation.WHITE, 10, 11);
	ban.playStone(Affiliation.WHITE, 11, 10);
	ban.playStone(Affiliation.WHITE, 10, 9);
	ban.playStone(Affiliation.WHITE, 9, 10);
	ban.playStone(Affiliation.BLACK, 10, 12);
	ban.playStone(Affiliation.BLACK, 11, 11);
	ban.playStone(Affiliation.BLACK, 12, 10); 
	ban.playStone(Affiliation.BLACK, 9, 11);
	ban.playStone(Affiliation.BLACK, 8, 10);
	ban.playStone(Affiliation.BLACK, 10, 8);
	ban.playStone(Affiliation.BLACK, 11, 9);
	ban.playStone(Affiliation.BLACK, 9, 9);
	
	System.out.println(ban.toString());
	ban.capture(9, 9);	
	System.out.println(ban.toString());
	ban.markTerritory(Affiliation.BLACK, 10, 10);
	System.out.println(ban.toString());
	...
	ban.playStone(Affiliation.WHITE, 9, 8);
	ban.playStone(Affiliation.WHITE, 8, 9);
	ban.playStone(Affiliation.WHITE, 10, 7);
	ban.playStone(Affiliation.WHITE, 11, 8);
	ban.playStone(Affiliation.WHITE, 12, 9);
	ban.playStone(Affiliation.WHITE, 13, 10);
	ban.playStone(Affiliation.WHITE, 7, 10);
	ban.playStone(Affiliation.WHITE, 8, 11);
	ban.playStone(Affiliation.WHITE, 9, 12);
	ban.playStone(Affiliation.WHITE, 10, 13);
	ban.playStone(Affiliation.WHITE, 11, 12);
